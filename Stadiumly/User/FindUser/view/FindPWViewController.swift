...
class FindPWViewController: UIViewController {
    ...
    @objc private func emailCheckButtonTapped() {
        ...
        let url = endPt + "/auth/find-pwd"
        let parameters = FindPWEmailRequest(email: insertedEmail)
        ...
        .validate()
        .responseDecodable(of: FindPWEmailResponse.self) { response in
    ...
    @objc private func codeCheckButtonTapped() {
        ...
        let url = endPt + "/auth/find-pwd-email-verify"
        let parameters = FindPWTokenCheckRequest(email: insertedEmail, token: insertedCode)
        ...
        AF.request(url,
                   ...
                   encoder: JSONParameterEncoder.default)
        .validate()
        .responseDecodable(of: FindPWTokenCheckResponse.self) { response in
            switch response.result {
            case .success:
    ...
    @objc private func changePWButtonTapped() {
        ...
        let url = endPt + "/auth/find-pwd-update"
        let parameters = ChangePWRequest(email: insertedEmail, password: newPW)
        ...
        AF.request(url,
                   ...
                   encoder: JSONParameterEncoder.default)
            .validate()
            .responseDecodable(of: ChangePWResponse.self) { response in
                switch response.result {
                case .success:
